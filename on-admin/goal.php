...
<div class="container">
  <div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><center>Log Produksi</h3>
    </div>
    ...
    if(isset($_GET['sdate']) || isset($_GET['edate']))
    {
      ...
      $sdate = $_GET['sdate'];
      $edate = $_GET['edate'];	
      $sqlAdmin = mysqli_query($koneksi, "SELECT data_id,data_tanggal,data_waktu,data_nilai FROM tb_data_produksi WHERE data_tanggal BETWEEN ' $sdate ' AND ' $edate ' ORDER BY ID DESC LIMIT 0,100");
    }
    else
    {
      $sqlAdmin = mysqli_query($koneksi, "SELECT data_id,data_tanggal,data_waktu,data_nilai FROM tb_data_produksi ORDER BY ID DESC LIMIT 0,100");
    }
    ?>
